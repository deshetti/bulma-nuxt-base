        ...
        <div class="columns">
          <div class="column is-4">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/admin.png" alt="Admin template screenshot">
                </figure>
              </div>
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/cards.png" alt="Cards template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/forum.png" alt="Hero template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/instaalbum.png" alt="Landing template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/landing.png" alt="Landing template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
          ...
          <div class="column is-4">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/band.png" alt="Band template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/hero.png" alt="Hero template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/kanban.png" alt="Kanban template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/login.png" alt="Login template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
          ...
          <div class="column is-4">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/blog.png" alt="Blog template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/cover.png" alt="Cover template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/inbox.png" alt="Inbox template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <figure class="image">
                  <img src="~/assets/images/kanban2.png" alt="Kanban template screenshot">
                </figure>
              </div>
              <footer class="card-footer">
